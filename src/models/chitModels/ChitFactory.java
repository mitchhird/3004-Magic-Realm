...
public class ChitFactory {
	...
	// fight
	public static ActionChit getFL22() {return new ActionChit("FL22", Weights.LIGHT, 2, 2, true);}
	public static ActionChit getFL31() {return new ActionChit("FL21", Weights.LIGHT, 3, 1, true);}
	public static ActionChit getFL40() {return new ActionChit("FL40", Weights.LIGHT, 4, 0, true);}
	public static ActionChit getFM32() {return new ActionChit("FM32", Weights.MEDIUM, 3, 2, true);}
	public static ActionChit getFM31() {return new ActionChit("FM31", Weights.MEDIUM, 3, 1, true);}
	public static ActionChit getFM40() {return new ActionChit("FM40", Weights.MEDIUM, 4, 0, true);}
	public static ActionChit getFM41() {return new ActionChit("FM41", Weights.MEDIUM, 4, 1, true);}
	public static ActionChit getFM50() {return new ActionChit("FM50", Weights.MEDIUM, 5, 0, true);}
	public static ActionChit getFH42() {return new ActionChit("FH42", Weights.HEAVY, 4, 2, true);}
	public static ActionChit getFH51() {return new ActionChit("FH51", Weights.HEAVY, 5, 1, true);}
	public static ActionChit getFH60() {return new ActionChit("FH60", Weights.HEAVY, 6, 0, true);}
	public static ActionChit getFT52() {return new ActionChit("FT52", Weights.TREMENDOUS, 5, 2,true);}
	public static ActionChit getFT61() {return new ActionChit("FT61", Weights.TREMENDOUS, 6, 1,true);}
